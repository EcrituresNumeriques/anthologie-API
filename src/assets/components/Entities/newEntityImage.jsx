...
export default class newEntityImage extends Component {
  ...
  handleSubmit = function (e) {
    ...
    let corps = {entities:this.refs.entity.value,URL:this.refs.URL.value,title:this.refs.title.value,credit:this.refs.credit.value,}
    fetch("/api/v1/images",
      {
          method: "POST",
      ...
      .then(function(data){
        browserHistory.push('/entities/'+corps.entities);
        return null;
      });
  }
