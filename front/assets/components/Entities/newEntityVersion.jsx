...
export default class newEntityVersion extends Component {
  ...
  handleSubmit = function (e) {
    ...
    fetch("/api/v1/entities/"+corps.id_entity+"/versions",
      {
          method: "POST",
  ...
  componentWillMount(){
    document.title = "Add new entity version | anthologie";
  }
